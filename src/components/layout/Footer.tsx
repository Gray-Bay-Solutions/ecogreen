    ...
    <footer className="bg-primary text-white pt-12 pb-6">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tours" className="hover:text-highlight transition-colors">
                  Tours
                </Link>
              </li>
              {/* <li>
              ...
              <li>
                <Link href="/booking" className="hover:text-highlight transition-colors">
                  Book Now
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <a href="#" className="hover:text-highlight transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-white/20 mt-8 pt-6 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Eco Green Nosara. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
